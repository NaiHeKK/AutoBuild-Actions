...
LOAD_VARIABLE() {
	...
	Github_Tag_Name=$(awk '/tag_name/ {print $2}' ${Run_Path}/Github_Tags | egrep -o "[0-9].+[0-9]")
...
Log_Path=/tmp
Script_URL=https://ghproxy.com/https://raw.githubusercontent.com/${FW_Author}/AutoBuild-Actions/master/Scripts/AutoUpdate.sh
